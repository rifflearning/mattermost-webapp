...
export function applyTheme(theme) {
    if (theme.sidebarBg) {
        ...
        changeCss('.modal-tabs .nav-tabs > li.active', `border-bottom-color:${theme.sidebarBg}`);
    }
    ...
    if (theme.sidebarText) {
        ...
        changeCss('.modal .settings-modal .nav-pills>li button', 'color:' + changeOpacity(theme.sidebarText, 0.6));
        ...
        changeCss('.icon__bot', 'fill:' + theme.sidebarText);
    }
    ...
    if (theme.sidebarHeaderTextColor) {
        ...
        changeCss('#navbar_wrapper .navbar-default .navbar-brand', 'color:' + theme.sidebarHeaderTextColor);
        changeCss('#navbar_wrapper .navbar-default .navbar-toggle .icon-bar', 'background:' + theme.sidebarHeaderTextColor);
    ...
    if (theme.centerChannelBg) {
        changeCss('@media(max-width: 768px){.post .MenuWrapper .dropdown-menu button', 'background:' + theme.centerChannelBg);
        ...
        changeCss('.search-help-popover .search-autocomplete__divider span', 'background:' + theme.centerChannelBg);
        ...
        changeCss('body', 'scrollbar-face-color:' + theme.centerChannelBg);
        changeCss('body', 'scrollbar-track-color:' + theme.centerChannelBg);
        ...
        changeCss('.modal-tabs .nav-tabs > li', `background:${theme.centerChannelBg}`);
        changeCss('.modal-tabs .nav-tabs > li > a', `background:${theme.centerChannelBg}`);
    ...
    if (theme.centerChannelColor) {
        ...
        changeCss('.MenuWrapper .MenuItem > button:hover, .Menu .MenuItem > button:hover, .MenuWrapper .MenuItem > button:focus, .MenuWrapper .MenuItem > a:hover, .dropdown-menu div > a:focus, .dropdown-menu div > a:hover, .dropdown-menu li > a:focus, .dropdown-menu li > a:hover', 'background:' + changeOpacity(theme.centerChannelColor, 0.1));
    ...
    if (theme.linkColor) {
        ...
        changeCss('.DayPicker-Day--today, .channel-header .channel-header__favorites.inactive:hover, .channel-header__links > a.active, a, a:focus, a:hover, .channel-header__links > .color--link.active, .color--link, a:focus, .color--link:hover, .btn, .btn:focus, .btn:hover', 'color:' + theme.linkColor);
        ...
        changeCss('.channel-header__links .icon:hover, .channel-header__links > a.active .icon, .post .flag-icon__container.visible, .post .post__reply', 'fill:' + theme.linkColor);
        changeCss('.channel-header__links .icon:hover, .post .flag-icon__container.visible, .post .card-icon__container.active svg, .post .post__reply', 'fill:' + theme.linkColor);
