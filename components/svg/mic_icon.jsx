...
export default class MicIcon extends React.PureComponent {
    render() {
        const micEnabled = !this.props.audioMuted;
        if (micEnabled) {
            return (
                <span {...this.props}>
                    <svg
                        ...
                        viewBox='0 0 24 24'
                        role='icon'
                        aria-label={localizeMessage('generic_icons.mic_enable', 'Mic Enabled Icon')}
                    >
                        <path
        ...
        return (
            <span {...this.props}>
                <svg
                    ...
                    viewBox='0 0 24 24'
                    role='icon'
                    aria-label={localizeMessage('generic_icons.mic_muted', 'Mic Muted Icon')}
                >
                    <path
                        fill='none'
